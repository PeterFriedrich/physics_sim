...
export const g = 9.81; // m/s², acceleration due to gravity near Earth
export const G = 6.67e-11; // N·m²/kg²
export const k = 8.99e9; // N·m²/C², Coulomb's constant
export const e = 1.6e-19; // C, elementary charge
export const c = 3.0e8; // m/s, speed of light in a vacuum
export const h = 6.63e-34; // J·s, Planck's constant
export const hEv = 4.14e-15; // eV·s, Planck's constant
export const eV = 1.6e-19; // J per electron volt
